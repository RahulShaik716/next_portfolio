...
export default function ProjectModal({
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-3xl bg-white rounded-lg shadow-lg overflow-hidden h-[90vh]">
        <button
          className="absolute top-4 right-4 p-2 hover:bg-slate-300 bg-white focus:outline-none"
