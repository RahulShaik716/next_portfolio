...
export default function Footer() {
  return (
    <div className="fixed bottom-0  w-full hidden md:flex flex-row justify-between bg-background text-foreground z-10 shadow-md p-2 border-t border-slate-300 items-center">
      <div>
